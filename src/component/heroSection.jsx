    ...
    <div className="bg-white ">
      <header className="relative inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:gap-x-12 justify-content-center">
            {navigation.map((item) => (
      ...
      <div className="relative isolate px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-8 sm:py-14 lg:py-18">
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
              Manage Your Meetings, Effortlessly
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Schedule, track, and collaborate on meetings — 
              all in one place with MetricHub.
            </p>
